  ...
  return (
    <section id="about" className="py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          {/* About Me heading: always first on mobile, before pic and text */}
          <h3 className="block md:hidden text-3xl font-light text-beige-900 dark:text-dark-text mb-6 w-full text-center">
            About Me
          </h3>
          ...
          <div className="flex-1 order-3 md:order-2">
            <h3 className="hidden md:block text-3xl font-light text-beige-900 dark:text-dark-text mb-6">
              About Me
            </h3>
